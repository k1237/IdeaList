<template>
  <div class="w-11/12 m-auto">
    <br />
    <p>
      IdeaList（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
    </p>
    <br />
    <br />
    <h1 class="text-xl font-extrabold">第1条（個人情報）</h1>
    <p>
      「個人情報」とは，個人情報保護法にいう「個人情報」を指すものとし，生存する個人に関する情報であって，当該情報に含まれる氏名，生年月日，住所，電話番号，連絡先その他の記述等により特定の個人を識別できる情報及び容貌，指紋，声紋にかかるデータ，及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。
    </p>
    <br />
    <br />
    <h1 class="text-xl font-extrabold">第2条（個人情報の収集方法）</h1>
    <p>
    ...
    <h1 class="text-xl font-extrabold">第4条（利用目的の変更）</h1>
    <p>
    ...
    <br />
    <br />
    <h1 class="text-xl font-extrabold">第5条（個人情報の第三者提供）</h1>
    <p>
    ...
    <br />
    <br />
    <h1 class="text-xl font-extrabold">第6条（個人情報の開示）</h1>
    <p>
      1.当社は，本人から個人情報の開示を求められたときは，本人に対し，遅滞なくこれを開示します。ただし，開示することにより次のいずれかに該当する場合は，その全部または一部を開示しないこともあり，開示しない決定をした場合には，その旨を遅滞なく通知します。なお，個人情報の開示に際しては，1件あたり1，000円の手数料を申し受けます。<br /><br />
    ...
    <br />
    <br />
    <h1 class="text-xl font-extrabold">第7条（個人情報の訂正および削除）</h1>
    <p>
    ...
    <br />
    <br />
    <h1 class="text-xl font-extrabold">第8条（個人情報の利用停止等）</h1>
    <p>
    ...
    <br />
    <br />
    <h1 class="text-xl font-extrabold">第9条（プライバシーポリシーの変更）</h1>
    <p>
    ...
    <br />
    <br />
    <h1 class="text-xl font-extrabold">第10条（お問い合わせ窓口）</h1>
    <p>
      本ポリシーに関するお問い合わせは，下記の窓口までお願いいたします。
      <br />
      氏名：K<br />
      Eメールアドレス：biz-kouta1237@outlook.jp<br />
    </p>
    <br />
    <p>以上</p>
  </div>
